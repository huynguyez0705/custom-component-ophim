...
<li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
  ...
  <span class="breadcrumb_last" itemprop="name"><?php echo esc_html($cate_name); ?></span>
  <meta itemprop="position" content="2" />
  <?php if ($paged > 1) { ?> <i class="fa fa-caret-right"></i> <?php } ?>
</li>
<?php if ($paged > 1) { ?>
<li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
...
<li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
  ...
  <span clas="breadcrumb_last" itemprop="name"><?php echo esc_html($title); ?></span>
  <meta itemprop="position" content="3" />
</li>
<?php }
} ?>
...
<li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
  ...
  <span clas="breadcrumb_last" itemprop="name"><?php echo esc_html($title_epis); ?></span>
