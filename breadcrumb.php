...
<ul class="breadcrumb">
    <li>
        <a class="" title="Xem Phim" href="/"><span class=""><i class="fa fa-home"></i> Phimmoi</span></a>
    </li>
    <?php if (is_tax()) { ?>
    <li>
        <span class="breadcrumb_last"><?= single_tag_title(); ?></span>
    </li>
    <?php } else if(is_archive()) { ?>
    <li><span class="breadcrumb_last">Kho Phim Mới</span></li>
    <?php } else if(is_search()) { ?>

    <li>
        <span class="breadcrumb_last">Kết quả tìm kiếm:
    ...
    <li>
        <a href="<?php echo home_url('/') . (get_option('ophim_slug_categories') ? get_option('ophim_slug_categories') : 'categories') . '/' . $term->slug . '/'; ?>"
            title="<?php echo esc_attr($term->name); ?>"><span><?php echo esc_html($term->name); ?></span></a>
    </li>
    <?php } ?>
    <?php if (isEpisode()) { ?>
    <li>
    ...
    <li>
        <span class="breadcrumb_last">Tập
            <?= episodeName() ?></span>
    </li>
